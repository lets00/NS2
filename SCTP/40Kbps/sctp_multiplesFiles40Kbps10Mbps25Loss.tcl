...
set nf [open sctpMultiplesFiles40Kbps10Mbps.nam w]
$ns namtrace-all $nf

set TraceFile [open sctpMultiplesFiles40Kbps10Mbps.tr w]
...
$loss_module set rate_ 0.25
$loss_module drop-target $n2
...
proc finish {} {
	...
	close $TraceFile
#	close $nf
	exec nam sctpMultiplesFiles40Kbps10Mbps &
	exit 0
}
